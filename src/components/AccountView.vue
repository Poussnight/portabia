...
<template>
  <main style="max-width:880px;margin:0 auto;padding:48px 32px 90px;">
    ...
    <div style="display:flex;justify-content:space-between;align-items:baseline;flex-wrap:wrap;gap:12px;margin-bottom:28px;">
      <h1 style="font-family:var(--font-display);font-weight:400;font-size:clamp(30px,4vw,44px);letter-spacing:-.02em;margin:0;">Bonjour, {{ user?.name || 'vous' }}.</h1>
    ...
    <div style="display:grid;grid-template-columns:1fr;gap:18px;">
      <!-- Historique -->
      <div :style="card">
        <h2 style="font-family:var(--font-display);font-weight:400;font-size:24px;margin:0 0 4px;">Historique de vos ponts</h2>
      ...
      <!-- Parrainage -->
      <div :style="card">
        <h2 style="font-family:var(--font-display);font-weight:400;font-size:24px;margin:0 0 4px;">Inviter un contact</h2>
      ...
      <!-- Profil / RGPD -->
      <div :style="card">
        <h2 style="font-family:var(--font-display);font-weight:400;font-size:24px;margin:0 0 12px;">Votre compte</h2>
